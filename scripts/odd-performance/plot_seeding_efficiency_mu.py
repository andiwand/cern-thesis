...
parser.add_argument("mu1GeV_seeding_perf", type=Path)
parser.add_argument("mu10GeV_seeding_perf", type=Path)
parser.add_argument("mu100GeV_seeding_perf", type=Path)
parser.add_argument(
    "--output",
    type=Path,
...
pts = [1, 10, 100]
seeding_perf = [
    args.mu1GeV_seeding_perf,
    args.mu10GeV_seeding_perf,
    args.mu100GeV_seeding_perf,
]
...
for i, pt, perf in zip(range(3), pts, seeding_perf):
