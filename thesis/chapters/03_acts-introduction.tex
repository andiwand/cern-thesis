...
The charge/momentum parameter captures the curvature of the trajectory given a magnetic field at the position. This choice can be motivated with the equation of motion for a free particle in a magnetic field. Note that the charge is signed and the momentum is the magnitude of the momentum vector. Using the absolute momentum magnitude over the traverse momentum magnitude is more general given an arbitraty magnetic field. To extract the momentum, one has to assume an absolute charge.
