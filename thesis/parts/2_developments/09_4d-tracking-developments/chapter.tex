\begin{itemize}
    ...
    \item cite physcis study on flavor tagging \cite{pub-2023-023}
    \begin{itemize}
...
Tracking sensors with timing information are a relatively recent development in high energy physics. The ATLAS detector will have a partial coverage of timing information with the next ugparde \cite{hgtd-tdr} , while the CMS detector will have a full coverage \cite{cms-mtd-tdr} . This new measurement dimension has the potential to improve pile-up rejection, particle identification and flavor tagging. It can also be used to reduce the combinatorial complexity of the event and therefore reduce the computational cost to reconstruct it.
