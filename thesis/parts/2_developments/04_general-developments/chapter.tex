\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item new challenges: telescope detectors, low momentum tracking, high pileup, time measurements
    \end{itemize}
    \item quickly walk through the chapters in this part, flash what was done during the work on this thesis
    \item quickly walk through this chapter
\end{itemize}
...
\begin{itemize}
    \color{red}
    \item quickly recap on propagation
    \item what was done during the work on this thesis?
    \begin{itemize}
        \item reworked options
        \item initialization
        \item reworked propagation loop and separated concerns
        \item merging actor aborter
        \item propagation state to distinquish init, step, and finalize
        \item alternative steering mechanism
    \end{itemize}
    \item quickly flash stepper and navigator developments and point to the chapters
\end{itemize}
...
\begin{itemize}
    \color{red}
    \item what is the purpose of developing the examples framework
    \item high level overview of the examples framework developments
