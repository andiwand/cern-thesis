...
\begin{figure}[H]
    ...
    \caption{Illustration of the ODD layout from a ZR view, segmented into: Beam pip, Pixels, Short Strips, Long Strips, and Solenoid. The solid lines inside the sub detectors represent the layers. The dashed lines represent different pseudo rapidity $\eta$ regions.}
