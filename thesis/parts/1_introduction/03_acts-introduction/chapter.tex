...
To make sense of physical quantities, ACTS uses a defined set of units for all relevant quantities. They can be found in \texttt{Acts/Definitions/Units.hpp}.
