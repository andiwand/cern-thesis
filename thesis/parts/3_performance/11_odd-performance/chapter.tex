...
The performance of the seeding is essential for the track finding performance. A particle's track can only be reconstructed if there is a seed for it. Seed deduplication can be used to avoid duplication of tracks.
